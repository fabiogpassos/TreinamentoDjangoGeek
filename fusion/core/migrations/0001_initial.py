# Generated by Django 3.1.3 on 2020-11-06 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni_cog', 'Engrenagem'), ('lni_stats-up', 'Gráfico'), ('lni_users', 'Usuários'), ('lni_layers', 'Design'), ('lni_mobile', 'Mobile'), ('lni_rocket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
